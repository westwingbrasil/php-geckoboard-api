...
JSON;
    ...
    public function testJsonForFullData()
    {
        ...
        $myWidget->setId('56797-7e3d4237-f798-433a-abe7-ac1857dfdf0f')
            ...
            ->setXAxisTitle('Month')
            ->setSeries([
                'Tokyo' => [7.0, 6.9, 9.5, 14.5, 18.4, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6],
...
JSON;
    ...
    public function testJsonAddingData()
    {
        ...
        $myWidget->setId('56797-7e3d4237-f798-433a-abe7-ac1857dfdf0f')
            ...
            ->setTitle('Monthly Average Temperature')
            ->setSubtitle('Source: WorldClimate.com')
            ->setYAxisLabels(['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'])
            ->setYAxisTitle('Temperature (°C)');
        $series = [
            'Tokyo' => [7.0, 6.9, 9.5, 14.5, 18.4, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6],
            'London' => [3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8],
...
JSON;
    ...
    public function testJsonForPieChart()
    {
        ...
        $myWidget->setId('56797-7e3d4237-f798-433a-abe7-ac1857dfdf0f')
            ...
            ->setPlotBorderColor(null)
            ->setBorderRadius(15)
            ->setTitle('Browser market shares January, 2015 to May, 2015');
        $series = [
            'name' => 'Brands',
            'colorByPoint' => true,
            'data' => [
